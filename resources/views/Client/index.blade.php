...
<x-client.head />
  ...
  <body>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('asset/vendors/popper/popper.min.js')}}"></script>
    <script src="{{asset('asset/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('asset/vendors/anchorjs/anchor.min.js')}}"></script>
    <script src="{{asset('asset/vendors/is/is.min.js')}}"></script>
    <script src="{{asset('asset/vendors/echarts/echarts.min.js')}}"></script>
    <script src="{{asset('asset/vendors/fontawesome/all.min.js')}}"></script>
    <script src="{{asset('asset/vendors/lodash/lodash.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{asset('asset/vendors/list.js/list.min.js')}}"></script>
